...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    // No navigation or state setting here. useAuth's onAuthStateChange handles it.
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground mt-1">Bem-vindo de volta ao Super Serviço!</p>
      </div>
